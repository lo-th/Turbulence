...
getGeometry:function(a,b,c){b=b||1;c=c||"z";var d=[1,1,1];"x"==c&&(d[0]=-1);"y"==c&&(d[1]=-1);"z"==c&&(d[2]=-1);b=(new THREE.Matrix4).makeScale(b*d[0],b*d[1],b*d[2]);a=this.meshs[a].geometry;a.applyMatrix(b);a.computeBoundingBox();a.computeBoundingSphere();return a},geo:function(a,b,c){return this.getGeometry(a,b,c)},mesh:function(a){return this.meshs[a]},load:function(a,b){this.loadModels(a,b)}};
