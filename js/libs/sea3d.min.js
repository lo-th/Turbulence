...
a instanceof String)a=[a];var d=a[0].substring(a[0].lastIndexOf("/")+1,a[0].lastIndexOf("."));c=c||"default";var e=this,f=new THREE.SEA3D(!0);f.onComplete=function(c){for(c=f.meshes.length;c--;)e.names[c]=d+"_"+f.meshes[c].name,e.meshs[e.names[c]]=f.meshes[c];a.shift();a.length?e.loadModels(a,b):b&&b()};f.parser="auto"==c?THREE.SEA3D.AUTO:"buffer"==c?THREE.SEA3D.BUFFER:THREE.SEA3D.DEFAULT;f.load(a[0])},getList:function(){for(var a="",b=0;b<this.names.length;b++)a+=this.names[b]+"<br>";return a},getMesh:function(a){return this.meshs[a]},
getGeometry:function(a,b,c){return this.scaleGeo(this.meshs[a].geometry)},scaleGeo:function(a,b,c){b=b||1;c=c||"z";var d=[1,1,1];"x"==c&&(d[0]=-1);"y"==c&&(d[1]=-1);"z"==c&&(d[2]=-1);b=(new THREE.Matrix4).makeScale(b*d[0],b*d[1],b*d[2]);a.applyMatrix(b);a.computeBoundingBox();a.computeBoundingSphere();return a},geo:function(a,b,c){return this.getGeometry(a,b,c)},mesh:function(a){return this.meshs[a]},load:function(a,b,c){this.loadModels(a,b,c)},edit:function(a,b,c,d,e){a=this.scaleGeo(this.meshs[a].geometry.clone());
var f;b=b||100;console.log(a.boundingBox);a.vertices?(f=a.vertices,console.log("is not buffer")):console.log("is buffer object");c=0.5*a.boundingBox.max.x;for(d=f.length;d--;)e=f[d],e.x>c&&(e.x+=b-c);a.verticesNeedUpdate=!0;return a}};
